...
public final class CatalogStore: @unchecked Sendable {
    ...
    private func migrate() throws {
        ...
        // The People feature was removed, but `catalog_people`,
        // `catalog_face_analysis` and `catalog_faces` are still created so
        // catalogs written by earlier versions keep opening unchanged. The
        // tables are never read or written now; only the schema is retained.
        try execute(
            """
